...
const AppContent = () => {
  ...
  const renderPage = () => {
    switch (currentPage) {
      case "home":
        return (
          <HomePage setPage={setCurrentPage} navigateToDetails={goToDetails} />
        );
      case "listings":
        return <ListingsPage navigateToDetails={goToDetails} />;
      case "details":
        return (
          <PropertyDetailsPage
      ...
      case "dashboard":
        return isAuthenticated ? (
          <UserDashboardPage setPage={setCurrentPage} />
        ) : (
      ...
      case "createListing":
        return isLister ? (
          <CreateListingPage setPage={setCurrentPage} />
        ) : (
          <div className="text-center py-20 text-red-600 text-2xl">
            Only agents/landlords can list
          </div>
        );
      default:
        return (
